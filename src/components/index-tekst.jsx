import '../styles/scss/indexTekst.scss';
import Home from '../assets/Fotos/57325198_2075682595883031_8842221344629194752_n.jpg'

function IndexTekst() {
    return (
        <>
            <h2 className='indexHeading'>Velkommen</h2>
            <div className="indexTekst">
                <div className='indexTekst__container'>
